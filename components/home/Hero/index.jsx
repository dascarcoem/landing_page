...
const Hero = () => {
  return (
    <div className='relative w-full h-screen  bg-[#001011] ' >
        <img alt='Home Background'  className=' !absolute right-0 !h-full hidden md:block ' src='/Home/home-bg.png' />
        <div className='w-full lg:w-2/3 h-full flex flex-col items-center justify-center ml-[calc(100vw*0.05)] relative z-10' >
          <motion.h1
